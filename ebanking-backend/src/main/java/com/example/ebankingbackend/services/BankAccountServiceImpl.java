...
public class BankAccountServiceImpl implements BankAccountService {
   ...
   @Override
    public List<AccountOperationDTO> accountHistory(String accountId){
        ...
        return accountOperations.stream().map(op->dtoMapper.fromAccountOpeartion(op)).collect(Collectors.toList());
    }
    ...
    public AccountHistoryDTO getAccountHistory(String accountId, int page, int size) throws BankAccountNotFoundException {
        ...
        List<AccountOperationDTO> accountOperationDTOS= accountOperations.getContent().stream().map(op->dtoMapper.fromAccountOpeartion(op)).collect(Collectors.toList());
